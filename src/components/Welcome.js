  ...
  return (
    <div className={style.wrapper}>
      ...
      <p className={style.info}>
        Thank you for signing up with Bingo and protecting your pup. <br /> If you need any help, please contact us at:
        <span> support@joinbingo.co</span>
      </p>
      <p>
        As a reminder, your coverage takes effect after a 3 day waiting period. <br /> When a claim does arrise, please
        email the vet bill to: <span>claims@joinbingo.co</span>
      </p>
